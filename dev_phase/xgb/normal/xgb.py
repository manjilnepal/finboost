...
sys.path.append('/home/dgxuser40/manjil/finsurv/utilities')
...
SUBMISSION_DIR = f'curs_{LR}_{ROUNDS}_boost_xgb'
...
output_zip_filename = f'new_hp_{LR}_{ROUNDS}_boost_xgb'
