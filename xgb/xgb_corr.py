...
## --- DEFINE PATH --- ##
PARTICIPANT_DATA_PATH = '/home/dgxuser40/manjil/finsurv/new_participant_data'
SUBMISSION_DIR = f'corr_{LR}_{ROUNDS}_boost_xgb'
...
output_zip_filename = f'corr_{LR}_{ROUNDS}_boost_xgb'
